...
$l['modcpnewsbars_title_setting_2'] = 'Affichage des alertes ModCP Newsbars';
$l['modcpnewsbars_description_setting_2'] = 'Entrez le texte que vous voulez afficher dans Alert.';
...
$l['modcpnewsbars_description_setting_4'] = 'Entrez le texte que vous voulez afficher dans la remarque 1.';

// Réglage 5

$l['modcpnewsbars_title_setting_5'] = 'Voulez-vous activer ModCP Newsbars Notice 1?';
$l['modcpnewsbars_description_setting_5'] = 'Si vous activez cette option, Notification 1 sera active sur votre modcp.';

// Réglage 6

$l['modcpnewsbars_title_setting_6'] = 'ModCP Newsbars Notice 2 Display';
$l['modcpnewsbars_description_setting_6'] = 'Entrez le texte que vous voulez afficher dans la remarque 2.';
